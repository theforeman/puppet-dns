...
describe 'dns::zone' do
  ...
  on_supported_os.each do |os, os_facts|
    context "on #{os}" do
      ...
      it 'has valid zone configuration' do
      ...
      it 'creates zone file' do
        is_expected.to contain_file("#{zonefilepath}/db.example.com").with({
                                                                             owner: user_name,
                                                                             group: user_name,
                                                                             mode: '0644',
                                                                             replace: 'false',
      ...
      it 'has valid zone file contents' do
      ...
      context 'when allow_transfer defined' do
        ...
        it 'has valid zone configuration with allow-transfer' do
          verify_concat_fragment_exact_contents(catalogue, 'dns_zones+10__GLOBAL__example.com.dns', [
                                                  'zone "example.com" {',
                                                  '    type master;',
                                                  "    file \"#{zonefilepath}/db.example.com\";",
      ...
      context 'when also_notify defined' do
        ...
        it 'has valid zone configuration with also-notify' do
          verify_concat_fragment_exact_contents(catalogue, 'dns_zones+10__GLOBAL__example.com.dns', [
                                                  'zone "example.com" {',
                                                  '    type master;',
                                                  "    file \"#{zonefilepath}/db.example.com\";",
      ...
      context 'when zonetype => slave' do
        ...
        it 'has valid slave zone configuration' do
          verify_concat_fragment_exact_contents(catalogue, 'dns_zones+10__GLOBAL__example.com.dns', [
                                                  'zone "example.com" {',
                                                  '    type slave;',
                                                  "    file \"#{zonefilepath}/db.example.com\";",
        ...
        context 'views feature with two views' do
          let(:params) { { target_views: %w[office dmz] } }
          ...
          it 'has valid slave zone configuration in office view' do
          ...
          it 'has valid slave zone configuration in dmz view' do
          ...
          it { is_expected.not_to contain_concat__fragment('dns_zones+10__GLOBAL__example.com.dns') }
        end
      end
      ...
      context 'when zonetype => forward' do
        ...
        it 'has valid forward zone configuration' do
          verify_concat_fragment_exact_contents(catalogue, 'dns_zones+10__GLOBAL__example.com.dns', [
                                                  'zone "example.com" {',
                                                  '    type forward;',
                                                  '    forward only;',
        ...
        context 'when parameters are set that are not allowed options for zonetype => forward' do
          ...
          it 'has valid forward zone configuration without options that are not allowed' do
            verify_concat_fragment_exact_contents(catalogue, 'dns_zones+10__GLOBAL__example.com.dns', [
                                                    'zone "example.com" {',
                                                    '    type forward;',
                                                    '    forward first;',
