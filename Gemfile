...
gem 'beaker', {git: 'https://github.com/bastelfreak/beaker/', branch: 'arch2', "groups"=>["development"]}
gem 'beaker-docker', {git: 'https://github.com/bastelfreak/beaker-docker/', branch: 'arch', "groups"=>["development"]}
